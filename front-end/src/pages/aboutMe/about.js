...
function About() {
  return (
    ...
    <p> 
      ...
      I've taken classes like agile software development, data structures, algorithms, and computer systems organization, so I have a good understanding of computer scicne. 
